...
export class NuevoComponent implements OnInit {
  ...
  this.servicio.enviar_seguro('Web_Service/cargar_tipo_concepto',  {}  , token).pipe().subscribe(
    (data:any)  =>  {

       _this.tipo_movimiento=data;
    ...
    //  this.ngxUiLoaderService.start();
      ...
      this.servicio.enviar_seguro('Web_service/guardar_concepto', datos , token).pipe().subscribe(
       ...
       //   if  ( response['ok']  ) {
           ...
           // });
              this.router.navigate(['/principal/caja/concepto/lista']);
         // }
        },
        (error) =>  {
          //this.ngxUiLoaderService.stop();
